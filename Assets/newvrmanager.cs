...
/// </summary>
public class newvrmanager : MonoBehaviour
{
	/// <summary>
    ...
    public Vector3 relativePosition = new Vector3(1.2f, 3.053769946f, 1.4999998f);
	...
	{		
		keyboard.Enable();
		keyboard.SetPlaceholderMessage("Please enter the desired input?");

		keyboard.OnUpdate.AddListener(HandleUpdate);
		keyboard.OnSubmit.AddListener(HandleSubmit);
		keyboard.OnCancel.AddListener(HandleCancel);

		// Vector3 forwardDirection = localVRPlayerCamera.transform.forward;
		// float distance = 2f;  // You can adjust this value based on your requirement
		// Vector3 offset = forwardDirection * distance;

		// keyboard.gameObject.transform.position = localVRPlayerCamera.transform.position + offset;
